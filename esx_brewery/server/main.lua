...
RegisterServerEvent('esx_brewery:startHarvest')
AddEventHandler('esx_brewery:startHarvest', function(zone)
...
RegisterServerEvent('esx_brewery:stopHarvest')
AddEventHandler('esx_brewery:stopHarvest', function()
	local _source = source
	
	if PlayersHarvesting[_source] == true then
		PlayersHarvesting[_source]=false
		TriggerClientEvent('esx:showNotification', _source, 'You went out of the ~r~zone')
	else
...
RegisterServerEvent('esx_brewery:startTransform')
AddEventHandler('esx_brewery:startTransform', function(zone)
	local _source = source
...
RegisterServerEvent('esx_brewery:stopTransform')
AddEventHandler('esx_brewery:stopTransform', function()
	local _source = source
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Now you can transform hops')
		PlayersTransforming[_source]=true
	end
end)
...
RegisterServerEvent('esx_brewery:startSell')
AddEventHandler('esx_brewery:startSell', function(zone)
	local _source = source
...
RegisterServerEvent('esx_brewery:stopSell')
AddEventHandler('esx_brewery:stopSell', function()
	local _source = source
	...
	if PlayersSelling[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Now you can ~g~sell')
		PlayersSelling[_source]=true
	end
end)

RegisterServerEvent('esx_brewery:getStockItem')
AddEventHandler('esx_brewery:getStockItem', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_brewery:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_brewery:putStockItems')
AddEventHandler('esx_brewery:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_brewery:getPlayerInventory', function(source, cb)
	local xPlayer    = ESX.GetPlayerFromId(source)
